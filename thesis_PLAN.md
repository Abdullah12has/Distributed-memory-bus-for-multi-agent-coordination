...
**Title:** *The Coordination Cliff: How Context Compression Breaks Multi-Fragment LLM Workflows* (retitled 2026-06-03 from *Memory Bus for Multi-Fragment LLM Workflows: …*, itself the "Distributed"-dropped 2026-05-30 form — see ADR-009 addenda)
