...
F1 metric collapses. The verdict-rest on the workload-level CI
...
deployment of P1 versus P2 at all. The pre-registered predicate is
...
MultiHopRAG, $0.59$ between C1 family-a and HotpotQA) clear it by
...
Section~\ref{sec:calibrated}.) \textbf{Verdict: NO SHIFT
DETECTED (equivalence not established at $\pm 20\%$ TOST on either
frontier cell); consistent on the local arm} (the fine-grid re-resolution of
