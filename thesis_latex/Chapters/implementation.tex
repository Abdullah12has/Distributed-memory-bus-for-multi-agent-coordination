...
for transactional consistency. Pricing follows public frontier rates
(USD~$3$/$15$ per million input/output tokens, $\approx$
...
ACC-RAG~\cite{guo2025dynamic}). Because the pre-registered sign-flip
...
\textbf{FAISS-CPU} with an HNSW index (over Qdrant/Chroma/pgvector)
