...
frontier cell passes. The point estimates match the reference well
--- Qwen-2.5-72B sits $\sim 7\%$ from the canonical $\tau^{*}=2.5$,
...
group's multi-agent roadmap. The flagship \emph{Vignette~3.7 ---
period-end project reporting} use case~\cite{fcgusecase2026}, which
