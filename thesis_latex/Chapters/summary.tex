...
\subsection{Weak-dominance result and the $\theta$/$N$ ablation}
...
not empirically validated. The $\theta$/$N$ ablation
...
$\tau^{*}$ comparison is $33\%$ at per-family CTR, $58\%$ at the
$\pm 25\%$ tolerance band. The model is useful as a first-order
