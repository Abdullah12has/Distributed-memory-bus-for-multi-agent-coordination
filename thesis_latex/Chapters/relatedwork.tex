...
The artefacts of this thesis are built around large language models
whose architectural foundation is the
transformer~\cite{vaswani2017attention}. Its defining mechanism,
\emph{self-attention}, computes $N^2$ pairwise compatibility scores
...
The motivation chapter frames the work in terms of per-token cost;
this section anchors that framing in published measurements.
...
At $\approx$~USD~3 / 15 per million input / output tokens on the
frontier base tiers, one million $10{,}000$-token calls per day is
