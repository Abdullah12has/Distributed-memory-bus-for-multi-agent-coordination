...
The large language models this thesis builds on are developed on top of
...
gave the field instructions to spend \emph{training} compute productively
but no corresponding way for \emph{inference} compute, which is
...
disclosure measurement). However, the orthogonal multi-round-agent setting is left as future work.
...
\emph{What is missing.} No published work measures \emph{summary-level} inference disclosure: the
