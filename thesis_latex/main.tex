...
\abstract{This thesis designs, implements, and evaluates a distributed memory
  ...
  quality at 7B parameters with a 13B sanity arm, (iii) a catalogue of
  ...
  implementation. The compute envelope is a single Apple M4 Pro 48 GB
  workstation, and the deliverable is the manuscript together with an
...
\tiivistelma{T\"am\"a diplomity\"o suunnittelee, toteuttaa ja arvioi
  ...
  koordinaation laatuun 7B-mallikoossa ja 13B-tarkistusvarsi, (iii)
