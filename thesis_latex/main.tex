...
\abstract{Every token a multi-step LLM workflow reads costs energy,
  ...
  The prompt-compression literature is mature, but it measures
  compressors on single-fragment question-answering, whereas
  production workflows must combine information across several
  fragments each compressed on its own, and whether preserving
  single-fragment quality also preserves that harder property had
  never been tested. It does not:
